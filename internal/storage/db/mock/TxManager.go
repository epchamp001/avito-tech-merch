...
func (_m *TxManager) BeginTx(ctx context.Context) (pgx.Tx, error) {
	ret := _m.Called(ctx)
...
func (_m *TxManager) CommitTx(ctx context.Context, tx pgx.Tx) error {
...
func (_m *TxManager) RollbackTx(ctx context.Context, tx pgx.Tx) error {
	ret := _m.Called(ctx, tx)
...
func (_m *TxManager) Begin(ctx context.Context) (pgx.Tx, error) {
	ret := _m.Called(ctx)
...
func (_m *TxManager) Commit(ctx context.Context) error {
	ret := _m.Called(ctx)
...
func (_m *TxManager) Conn() *pgx.Conn {
	ret := _m.Called()
...
func (_m *TxManager) CopyFrom(ctx context.Context, tableName pgx.Identifier, columnNames []string, rowSrc pgx.CopyFromSource) (int64, error) {
...
func (_m *TxManager) Exec(ctx context.Context, sql string, arguments ...interface{}) (pgconn.CommandTag, error) {
	var _ca []interface{}
...
func (_m *TxManager) LargeObjects() pgx.LargeObjects {
	ret := _m.Called()
...
func (_m *TxManager) Prepare(ctx context.Context, name string, sql string) (*pgconn.StatementDescription, error) {
...
func (_m *TxManager) Query(ctx context.Context, sql string, args ...interface{}) (pgx.Rows, error) {
	var _ca []interface{}
	_ca = append(_ca, ctx, sql)
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
...
func (_m *TxManager) QueryRow(ctx context.Context, sql string, args ...interface{}) pgx.Row {
	var _ca []interface{}
	_ca = append(_ca, ctx, sql)
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
...
func (_m *TxManager) Rollback(ctx context.Context) error {
	ret := _m.Called(ctx)
...
func (_m *TxManager) SendBatch(ctx context.Context, b *pgx.Batch) pgx.BatchResults {
	ret := _m.Called(ctx, b)
